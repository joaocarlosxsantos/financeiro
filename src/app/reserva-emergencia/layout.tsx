...
export default function ReservaEmergenciaLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <main className="flex-1 flex flex-col min-h-screen overflow-auto w-full">
        {/* Topbar mobile */}
        <div className="md:hidden flex items-center h-14 px-4 border-b border-border bg-background sticky top-0 z-30">
          ...
          <span className="text-lg font-bold">Reserva de Emergência</span>
        </div>

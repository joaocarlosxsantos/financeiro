  ...
  return (
    ...
    >
      ...
      >
        ...
        {title && <div className="px-4 sm:px-8 pt-6 sm:pt-8 pb-2 text-base sm:text-lg font-semibold">{title}</div>}
        <div className="px-4 sm:px-8 pb-6 sm:pb-8 pt-2 overflow-y-auto" style={{ maxHeight: 'calc(80vh - 64px)' }}>{children}</div>
      </div>
    </div>
  )
}

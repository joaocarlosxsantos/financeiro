                ...
                <div className="flex-1">
                  {period.sourceFile && (
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-foreground/90 truncate" title={period.sourceFile}>
                        {period.sourceFile}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="flex gap-4 text-xs text-muted-foreground mt-2">
                    ...
                    <span className="bg-destructive/15 text-destructive px-2 py-1 rounded">

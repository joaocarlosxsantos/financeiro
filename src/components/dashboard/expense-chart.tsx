...
export function ExpenseChart({ data, maxItems }: ExpenseChartProps) {
  ...
  const handleExportCSV = () => {
    ...
    exportToCSV(csvData, 'despesas-por-categoria.csv');
  };

  const handleExportPNG = async () => {
    await exportToPNG('expense-chart-container', 'despesas-por-categoria.png');
  };
        ...
        <div id="expense-chart-container">
          ...
          <div className="grid grid-cols-3 gap-3 mb-6 p-4 bg-muted/50 rounded-lg">
            <div className="text-center">
              ...
              <p className="font-bold text-lg">{formatCurrency(visibleTotal)}</p>
            </div>
            <div className="text-center">
